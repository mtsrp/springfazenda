...
public class ClienteEntidade {
	...
	@OneToMany(mappedBy = "cliente", targetEntity = EnderecoCliEntidade.class, fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	private List <EnderecoCliEntidade> enderecos;
